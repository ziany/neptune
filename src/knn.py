...
positive=ngramGenerator.mostFreqList('../data/used/positive_processed.csv',2000)
negative=ngramGenerator.mostFreqList('../data/used/negative_processed.csv',2000)
neutral=ngramGenerator.mostFreqList('../data/used/neutral_processed.csv',2000)
